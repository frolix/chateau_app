...
class GuideSavedPlacesCard extends StatelessWidget {
  const GuideSavedPlacesCard({super.key});
          ...
          children: [
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                height: 51, // 3 рядки * 17px приблизно
                child: Text(
                  'Your favorite places will always be at your fingertips.',
