...
import 'package:chatau/features/onboarding/presentation/widgets/favorite_place_card.dart';
import 'package:chatau/features/onboarding/presentation/widgets/popular_places_grid.dart';
import 'package:chatau/features/onboarding/presentation/widgets/bottom_hero_image.dart';
...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  final buttonTexts = ['Nice to meet you!', 'Okey, next', 'Continue', 'Start'];
  ...
  void _next() async {
    if (_isFinishing) return; // захист від даблтапу
